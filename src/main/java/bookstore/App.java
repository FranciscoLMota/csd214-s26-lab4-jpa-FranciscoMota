...
public class App {
    ...
    public void addItem() {
        ...
        while (choice != 99) {
            ...
            System.out.println("5. Add Cassette");
            System.out.println("6. Add Vinyl");
            ...
            switch(choice) {
                ...
                case 5: item = new CassetteTape(); break;
                case 6: item = new VinylRecord(); break;
    ...
    private void saveToDb(Editable item) {
        ...
        } else if (item instanceof CassetteTape) {
            entity = ((CassetteTape) item).toEntity();
        } else if (item instanceof VinylRecord) {
            entity = ((VinylRecord) item).toEntity();
        }
    ...
    public void listAny() {
        ...
        while (choice != 99) {
            ...
            System.out.println("6. Cassette Tapes Only");
            System.out.println("7. Vinyl Records Only");
            System.out.println("99. Exit");
            ...
            switch(choice) {
                ...
                case 6: filterClass = CassetteTapeEntity.class; break;
                case 7: filterClass = VinylRecordEntity.class; break;
                default: System.out.println("Invalid selection."); continue;
            }
    ...
    private void printEntityAsDto(ProductEntity entity) {
        ...
        } else if (entity instanceof CassetteTapeEntity) {
            System.out.println(CassetteTape.fromEntity((CassetteTapeEntity) entity));
        } else if (entity instanceof VinylRecordEntity) {
            System.out.println(VinylRecord.fromEntity((VinylRecordEntity) entity));
        }
    }
        ...
        try {
            ...
            if (idx >= 0 && idx < entities.size()) {
                ...
                if (entity instanceof BookEntity) {
                    ...
                    CassetteTape dto = CassetteTape.fromEntity((CassetteTapeEntity) entity);
                    dto.edit(this.input);
                    em.merge(dto.toEntity());
                } else if (entity instanceof VinylRecordEntity) {
                    VinylRecord dto = VinylRecord.fromEntity((VinylRecordEntity) entity);
                    dto.edit(this.input);
                    em.merge(dto.toEntity());
                }
    ...
    public void populate() {
        ...
        try {
            for (int i = 0; i < 2; i++) {
                ...
                // Cassette
                CassetteTapeEntity c = new CassetteTapeEntity();
                c.setArtist(faker.rockBand().name());
                c.setTitle(faker.music().instrument());
                c.setHasAutoReverse(faker.bool().bool());
                c.setDateOfRelease(faker.date().birthday().toString());
                c.setPlaybackDurationMinutes(faker.number().numberBetween(0, 1000));
                em.persist(c);


                // Vinyl Records
                VinylRecordEntity v = new VinylRecordEntity();
                v.setArtist(faker.rockBand().name());
                v.setTitle(faker.music().instrument());
                v.setDateOfRelease(faker.date().birthday().toString());
                v.setPlaybackDurationMinutes(faker.number().numberBetween(0, 1000));
                v.setRecordSizeInches(faker.number().numberBetween(10, 40));
                v.setRotationsPerMinute(faker.number().numberBetween(0, 500));
                em.persist(v);
            }
            em.getTransaction().commit();
    ...
    public SaleableItem findItem(SaleableItem item) {
        ...
        for (ProductEntity entity : entities) {
            ...
            if (entity instanceof BookEntity) {
                ...
                pojo = CassetteTape.fromEntity((CassetteTapeEntity) entity);
            } else if (entity instanceof VinylRecordEntity) {
                pojo = VinylRecord.fromEntity((VinylRecordEntity) entity);
            }
